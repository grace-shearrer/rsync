...
<<<<<<< HEAD
#os.chdir('/Users/poldracklab/Desktop/onsets_logs/'+subject)
os.chdir('/corral-repl/utexas/poldracklab/data/sugar_brain/onset_logs/'+subject+'/taste')
...
<<<<<<< HEAD
path='/corral-repl/utexas/poldracklab/data/sugar_brain/onset_logs/'+subject+'/taste'
=======
...
<<<<<<< HEAD
    f_waterjuice=open('water_juice_'+base_filename+'.txt', 'w')
    f_juicewater=open('juice_water_'+base_filename+'.txt', 'w')
    f_task=open('task_'+base_filename+'.txt', 'w')
    f_swallow=open('swallow_'+base_filename+'.txt', 'w')
    f_rinse=open('rinse_'+base_filename+'.txt', 'w')
=======
